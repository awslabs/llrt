...
import * as legacyNamedImport from "child_process";
...
const modules = {
  "node:child_process": defaultImport,
  child_process: legacyImport,
  "* as child_process": legacyNamedImport,
};
for (const module in modules) {
  const { spawn } = modules[module];
