...
var keyData = {
  "P-521": {
    spki: new Uint8Array([
      ...
      0, 35, 3, 129, 134, 0, 4, 1, 86, 244, 121, 248, 223, 30, 32, 167, 255,
      192, 76, 228, 32, 195, 225, 84, 174, 37, 25, 150, 190, 228, 47, 3, 75,
      132, 212, 27, 116, 63, 52, 228, 95, 49, 27, 129, 58, 156, 222, 200, 205,
      165, 155, 187, 189, 49, 212, 96, 179, 41, 37, 33, 231, 193, 183, 34, 229,
      102, 124, 3, 219, 47, 174, 117, 63, 1, 80, 23, 54, 207, 226, 71, 57, 67,
      32, 216, 228, 175, 194, 253, 57, 181, 169, 51, 16, 97, 184, 30, 34, 65,
      40, 43, 158, 23, 137, 24, 34, 181, 183, 158, 5, 47, 69, 151, 181, 150, 67,
      253, 57, 55, 156, 81, 189, 81, 37, 196, 244, 139, 195, 240, 37, 206, 60,
      211, 105, 83, 40, 108, 203, 56, 251,
    ]),
    spki_compressed: new Uint8Array([
      48, 88, 48, 16, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 5, 43, 129, 4, 0, 35,
      3, 68, 0, 3, 1, 86, 244, 121, 248, 223, 30, 32, 167, 255, 192, 76, 228,
      32, 195, 225, 84, 174, 37, 25, 150, 190, 228, 47, 3, 75, 132, 212, 27,
      116, 63, 52, 228, 95, 49, 27, 129, 58, 156, 222, 200, 205, 165, 155, 187,
      189, 49, 212, 96, 179, 41, 37, 33, 231, 193, 183, 34, 229, 102, 124, 3,
      219, 47, 174, 117, 63,
    ]),
    raw: new Uint8Array([
      4, 1, 86, 244, 121, 248, 223, 30, 32, 167, 255, 192, 76, 228, 32, 195,
      225, 84, 174, 37, 25, 150, 190, 228, 47, 3, 75, 132, 212, 27, 116, 63, 52,
      228, 95, 49, 27, 129, 58, 156, 222, 200, 205, 165, 155, 187, 189, 49, 212,
      96, 179, 41, 37, 33, 231, 193, 183, 34, 229, 102, 124, 3, 219, 47, 174,
      117, 63, 1, 80, 23, 54, 207, 226, 71, 57, 67, 32, 216, 228, 175, 194, 253,
      57, 181, 169, 51, 16, 97, 184, 30, 34, 65, 40, 43, 158, 23, 137, 24, 34,
      181, 183, 158, 5, 47, 69, 151, 181, 150, 67, 253, 57, 55, 156, 81, 189,
      81, 37, 196, 244, 139, 195, 240, 37, 206, 60, 211, 105, 83, 40, 108, 203,
      56, 251,
    ]),
    raw_compressed: new Uint8Array([
      3, 1, 86, 244, 121, 248, 223, 30, 32, 167, 255, 192, 76, 228, 32, 195,
      225, 84, 174, 37, 25, 150, 190, 228, 47, 3, 75, 132, 212, 27, 116, 63, 52,
      228, 95, 49, 27, 129, 58, 156, 222, 200, 205, 165, 155, 187, 189, 49, 212,
      96, 179, 41, 37, 33, 231, 193, 183, 34, 229, 102, 124, 3, 219, 47, 174,
      117, 63,
    ...
    pkcs8: new Uint8Array([
      ...
      129, 4, 0, 35, 4, 129, 214, 48, 129, 211, 2, 1, 1, 4, 66, 0, 244, 8, 117,
      131, 104, 186, 147, 15, 48, 247, 106, 224, 84, 254, 92, 210, 206, 127,
      218, 44, 159, 118, 166, 212, 54, 207, 117, 214, 108, 68, 11, 254, 99, 49,
      199, 193, 114, 161, 36, 120, 25, 60, 130, 81, 72, 123, 201, 18, 99, 250,
      80, 33, 127, 133, 255, 99, 111, 89, 205, 84, 110, 58, 180, 131, 180, 161,
      129, 137, 3, 129, 134, 0, 4, 1, 86, 244, 121, 248, 223, 30, 32, 167, 255,
      192, 76, 228, 32, 195, 225, 84, 174, 37, 25, 150, 190, 228, 47, 3, 75,
      132, 212, 27, 116, 63, 52, 228, 95, 49, 27, 129, 58, 156, 222, 200, 205,
      165, 155, 187, 189, 49, 212, 96, 179, 41, 37, 33, 231, 193, 183, 34, 229,
      102, 124, 3, 219, 47, 174, 117, 63, 1, 80, 23, 54, 207, 226, 71, 57, 67,
  ...
  "P-256": {
    ...
    spki_compressed: new Uint8Array([
      ...
      61, 3, 1, 7, 3, 34, 0, 2, 210, 16, 176, 166, 249, 217, 240, 18, 134, 128,
      88, 180, 63, 164, 244, 113, 1, 133, 67, 187, 160, 12, 146, 80, 223, 146,
      87, 194, 172, 174, 93, 209,
    ]),
    raw: new Uint8Array([
    ...
    raw_compressed: new Uint8Array([
      2, 210, 16, 176, 166, 249, 217, 240, 18, 134, 128, 88, 180, 63, 164, 244,
      113, 1, 133, 67, 187, 160, 12, 146, 80, 223, 146, 87, 194, 172, 174, 93,
      209,
    ]),
    pkcs8: new Uint8Array([
  ...
  "P-384": {
    spki: new Uint8Array([
      ...
      34, 3, 98, 0, 4, 33, 156, 20, 214, 102, 23, 179, 110, 198, 216, 133, 107,
      56, 91, 115, 167, 77, 52, 79, 216, 174, 117, 239, 4, 100, 53, 221, 165,
      78, 59, 68, 189, 95, 189, 235, 209, 208, 141, 214, 158, 45, 125, 193, 220,
      33, 140, 180, 53, 189, 40, 19, 140, 199, 120, 51, 122, 132, 47, 107, 214,
      27, 36, 14, 116, 36, 159, 36, 102, 124, 42, 88, 16, 167, 107, 252, 40,
      224, 51, 95, 136, 166, 80, 29, 236, 1, 151, 109, 168, 90, 251, 0, 134,
      156, 182, 172, 232,
    ]),
    spki_compressed: new Uint8Array([
      48, 70, 48, 16, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 5, 43, 129, 4, 0, 34,
      3, 50, 0, 2, 33, 156, 20, 214, 102, 23, 179, 110, 198, 216, 133, 107, 56,
      91, 115, 167, 77, 52, 79, 216, 174, 117, 239, 4, 100, 53, 221, 165, 78,
      59, 68, 189, 95, 189, 235, 209, 208, 141, 214, 158, 45, 125, 193, 220, 33,
      140, 180, 53,
    ]),
    raw: new Uint8Array([
      4, 33, 156, 20, 214, 102, 23, 179, 110, 198, 216, 133, 107, 56, 91, 115,
      167, 77, 52, 79, 216, 174, 117, 239, 4, 100, 53, 221, 165, 78, 59, 68,
      189, 95, 189, 235, 209, 208, 141, 214, 158, 45, 125, 193, 220, 33, 140,
      180, 53, 189, 40, 19, 140, 199, 120, 51, 122, 132, 47, 107, 214, 27, 36,
      14, 116, 36, 159, 36, 102, 124, 42, 88, 16, 167, 107, 252, 40, 224, 51,
      95, 136, 166, 80, 29, 236, 1, 151, 109, 168, 90, 251, 0, 134, 156, 182,
      172, 232,
    ]),
    raw_compressed: new Uint8Array([
      2, 33, 156, 20, 214, 102, 23, 179, 110, 198, 216, 133, 107, 56, 91, 115,
      167, 77, 52, 79, 216, 174, 117, 239, 4, 100, 53, 221, 165, 78, 59, 68,
      189, 95, 189, 235, 209, 208, 141, 214, 158, 45, 125, 193, 220, 33, 140,
      180, 53,
    ]),
    pkcs8: new Uint8Array([
      ...
      129, 4, 0, 34, 4, 129, 158, 48, 129, 155, 2, 1, 1, 4, 48, 69, 55, 181,
      153, 7, 132, 211, 194, 210, 46, 150, 168, 249, 47, 161, 170, 73, 46, 232,
      115, 229, 118, 164, 21, 130, 225, 68, 24, 60, 152, 136, 209, 14, 107, 158,
      180, 206, 212, 178, 204, 64, 18, 228, 172, 94, 168, 64, 115, 161, 100, 3,
      98, 0, 4, 33, 156, 20, 214, 102, 23, 179, 110, 198, 216, 133, 107, 56, 91,
      115, 167, 77, 52, 79, 216, 174, 117, 239, 4, 100, 53, 221, 165, 78, 59,
      68, 189, 95, 189, 235, 209, 208, 141, 214, 158, 45, 125, 193, 220, 33,
      140, 180, 53, 189, 40, 19, 140, 199, 120, 51, 122, 132, 47, 107, 214, 27,
      36, 14, 116, 36, 159, 36, 102, 124, 42, 88, 16, 167, 107, 252, 40, 224,
      51, 95, 136, 166, 80, 29, 236, 1, 151, 109, 168, 90, 251, 0, 134, 156,
      182, 172, 232,
    ]),
    jwk: {
      kty: "EC",
  ...
  curves.forEach(function (curve) {
    [true, false].forEach(function (extractable) {
      ...
      allValidUsages(vector.publicUsages, true).forEach(function (usages) {
        ["spki", "spki_compressed", "jwk", "raw", "raw_compressed"].forEach(
          function (format) {
            ...
            if (format === "jwk") {
              ...
              data = {
                jwk: {
                  kty: keyData[curve].jwk.kty,
                  crv: keyData[curve].jwk.crv,
                  x: keyData[curve].jwk.x,
                  y: keyData[curve].jwk.y,
                },
              };
            }
            ...
            if (vector.name === "ECDH" && format === "jwk") {
              testEcdhJwkAlg(
                algorithm,
                { ...data.jwk, alg: "any alg works here" },
                curve,
                usages,
                extractable
              );
        ...
        .then(
          function (key) {
            ...
            assert_goodCryptoKey(
              ...
              extractable,
              usages,
              format === "pkcs8" || (format === "jwk" && keyData.d)
                ? "private"
                : "public"
            );
            if (!extractable) {
            ...
            return subtle.exportKey(format, key).then(
              function (result) {
                if (format !== "jwk") {
                  assert_true(
                    equalBuffers(data[format], result),
                    "Round trip works"
                  );
                } else {
                  assert_true(
                    equalJwk(data[format], result),
                    "Round trip works"
                  );
                }
              },
          ...
          function (err) {
            if (compressed && err.name === "DataError") {
              assert_implements_optional(
                false,
                "Compressed point format not supported: " + err.toString()
              );
            } else {
...
function testEmptyUsages(format, algorithm, data, keySize, extractable) {
  ...
  promise_test(
    ...
    "Empty Usages: " +
      keySize.toString() +
      " bits " +
      parameterString(format, false, keyData, algorithm, extractable, usages)
  );
}
