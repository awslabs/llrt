...
var testVectors = [
  ...
  {
    name: "HKDF",
    legalUsages: ["deriveBits", "deriveKey"],
    extractable: [false],
    formats: ["raw"],
  },
  {
        ...
        .then(
          function (key) {
            ...
            assert_goodCryptoKey(
              key,
              hasLength(key.algorithm)
                ? { length: keySize, ...algorithm }
                : algorithm,
              extractable,
              usages,
              "secret"
