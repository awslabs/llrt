...
describe("url", () => {
  ...
  // require("./url/historical.any.js");
  // Request.formData() not supported
  // require("./url/urlencoded-parser.any.js");

  it("should pass url-constructor.any.js tests", (done) => {
    runTest(require("./url/url-constructor.any.js").default, done);
  });

  it("should pass url-origin.any.js tests", (done) => {
    runTest(require("./url/url-origin.any.js").default, done);
  });

  it("should pass url-searchparams.any.js tests", (done) => {
    runTest(require("./url/url-searchparams.any.js").default, done);
  });

  it("should pass url-setters.any.js tests", (done) => {
    runTest(require("./url/url-setters.any.js").default, done);
  });

  it("should pass url-setters-stripping.any.js tests", (done) => {
    runTest(require("./url/url-setters-stripping.any.js").default, done);
  });

  it("should pass url-statics-canparse.any.js tests", (done) => {
    runTest(require("./url/url-statics-canparse.any.js").default, done);
  });

  it("should pass url-statics-parse.any.js tests", (done) => {
    runTest(require("./url/url-statics-parse.any.js").default, done);
  });

  it("should pass url-tojson.any.js tests", (done) => {
    runTest(require("./url/url-tojson.any.js").default, done);
  });
});
