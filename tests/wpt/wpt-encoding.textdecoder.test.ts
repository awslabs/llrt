...
describe("textdecoder", () => {
  it("should pass textdecoder-arguments.any.js", (done) => {
    runTest(require("./encoding/textdecoder-arguments.any.js").default, done);
  });

  it("should pass textdecoder-byte-order-marks.any.js", (done) => {
    runTest(
      require("./encoding/textdecoder-byte-order-marks.any.js").default,
      done
    );
  });
  ...
  //   runTest(
  //     require("./encoding/textdecoder-copy.any.js").default,
  //     done
  //   );
  // });

  it("should pass textdecoder-eof.any.js", (done) => {
    runTest(require("./encoding/textdecoder-eof.any.js").default, done);
  });

  // Current support is utf8 and utf16le
  // it("should pass textdecoder-fatal-single-byte.any.js", (done) => {
  //   runTest(
  //     require("./encoding/textdecoder-fatal-single-byte.any.js")
  //       .default,
  //     done
  //   );
  // });
  ...
  it("should pass textdecoder-fatal-streaming.any.js", (done) => {
    runTest(
      require("./encoding/textdecoder-fatal-streaming.any.js").default,
      done
    );
  });

  it("should pass textdecoder-fatal.any.js", (done) => {
    runTest(require("./encoding/textdecoder-fatal.any.js").default, done);
  });

  it("should pass textdecoder-ignorebom.any.js", (done) => {
    runTest(require("./encoding/textdecoder-ignorebom.any.js").default, done);
  });

  it("should pass textdecoder-labels.any.js", (done) => {
    runTest(require("./encoding/textdecoder-labels.any.js").default, done);
  });

  // stream option not implemented
  // it("should pass textdecoder-streaming.any.js", (done) => {
  //   runTest(
  //     require("./encoding/textdecoder-streaming.any.js")
  //       .default,
  //     done
  //   );
  // });
  ...
  it("should pass textdecoder-utf16-surrogates.any.js", (done) => {
    runTest(
      require("./encoding/textdecoder-utf16-surrogates.any.js").default,
      done
    );
  });
});
