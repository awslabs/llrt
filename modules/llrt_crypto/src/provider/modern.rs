...
// ML-DSA/ML-KEM/hybrid-KEM, gated behind `pqc` (~2% of binary size).
#[cfg(feature = "pqc")]
mod pqc {
    use crate::provider::{CryptoError, HybridKemVariant, MlDsaVariant, MlKemVariant};
...
// `pqc`-off fallback: same signatures, reports NotSupportedError.
#[cfg(not(feature = "pqc"))]
mod pqc {
    #![allow(dead_code)]
