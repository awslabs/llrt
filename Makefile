...
test: js
	cargo run --features pqc,intl402 -- test -d bundle/js/__tests__/$(TEST_SUB_DIR)
...
test-wpt: setup-wpt js
	...
	TEST_REPORT_FILE=wpt_errors.txt cargo run --features pqc,intl402 -- test -d bundle/js/__tests__/$(TEST_SUB_DIR); \
